...
public class TwitchStream implements BroadcastController.BroadcastListener, ChatController.ChatListener, IngestServerTester.IngestTestListener, IStream {
                ...
                public void run() {
                    try {
                        ...
                        if (JsonUtils.getBoolean(jsonobject1, "valid")) {
                            ...
                            Logger.debug("Authenticated with twitch; username is {}", new Object[]{s1});
                            ...
                            Logger.error("Given twitch access token is invalid");
                        }
                    } catch (IOException ioexception) {
                        TwitchStream.this.authFailureReason = IStream.AuthFailureReason.ERROR;
                        Logger.error((String) "Could not authenticate with twitch", (Throwable) ioexception);
                    }
                }
            };
    ...
    public void shutdownStream() {
        Logger.debug("Shutdown streaming");
    ...
    public void func_152935_j() {
        ...
        if (i == 2) {
            if (flag) {
                Logger.debug("Disconnecting from twitch chat per user options");
                this.chatController.func_175991_l(this.field_176029_e);
            }
        } else if (i == 1) {
            if (flag1 && this.broadcastController.func_152849_q()) {
                Logger.debug("Connecting to twitch chat per user options");
                this.func_152942_I();
            }
        } else if (i == 0) {
            if (flag && !this.isBroadcasting()) {
                Logger.debug("Disconnecting from twitch chat as user is no longer streaming");
                this.chatController.func_175991_l(this.field_176029_e);
            } else if (flag1 && this.isBroadcasting()) {
                Logger.debug("Connecting to twitch chat as user is streaming");
                this.func_152942_I();
            }
        }
    ...
    public void func_152911_a(Metadata p_152911_1_, long p_152911_2_) {
        if (this.isBroadcasting() && this.field_152957_i) {
            ...
            if (!this.broadcastController.func_152840_a(p_152911_1_.func_152810_c(), i + p_152911_2_, p_152911_1_.func_152809_a(), p_152911_1_.func_152806_b())) {
                Logger.warn("Couldn\'t send stream metadata action at {}: {}", new Object[]{Long.valueOf(i + p_152911_2_), p_152911_1_});
            } else {
                Logger.debug("Sent stream metadata action at {}: {}", new Object[]{Long.valueOf(i + p_152911_2_), p_152911_1_});
            }
        }
    }
    ...
    public void func_176026_a(Metadata p_176026_1_, long p_176026_2_, long p_176026_4_) {
        if (this.isBroadcasting() && this.field_152957_i) {
            ...
            if (j < 0L) {
                Logger.warn("Could not send stream metadata sequence from {} to {}: {}", new Object[]{Long.valueOf(i + p_176026_2_), Long.valueOf(i + p_176026_4_), p_176026_1_});
            } else if (this.broadcastController.func_177947_a(p_176026_1_.func_152810_c(), i + p_176026_4_, j, s, s1)) {
                Logger.debug("Sent stream metadata sequence from {} to {}: {}", new Object[]{Long.valueOf(i + p_176026_2_), Long.valueOf(i + p_176026_4_), p_176026_1_});
            } else {
                Logger.warn("Half-sent stream metadata sequence from {} to {}: {}", new Object[]{Long.valueOf(i + p_176026_2_), Long.valueOf(i + p_176026_4_), p_176026_1_});
            }
        }
    }
    ...
    public void requestCommercial() {
        if (this.broadcastController.requestCommercial()) {
            Logger.debug("Requested commercial from Twitch");
        } else {
            Logger.warn("Could not request commercial from Twitch");
        }
    }
    ...
    public void func_152930_t() {
        ...
        Logger.info("Streaming at {}/{} at {} kbps to {}", new Object[]{Integer.valueOf(videoparams.outputWidth), Integer.valueOf(videoparams.outputHeight), Integer.valueOf(videoparams.maxKbps), this.broadcastController.func_152833_s().serverUrl});
    ...
    public void stopBroadcasting() {
        if (this.broadcastController.stopBroadcasting()) {
            Logger.info("Stopped streaming to Twitch");
        } else {
            Logger.warn("Could not stop streaming to Twitch");
        }
    }
    ...
    public void func_152897_a(ErrorCode p_152897_1_) {
        if (ErrorCode.succeeded(p_152897_1_)) {
            Logger.debug("Login attempt successful");
            this.loggedIn = true;
        } else {
            Logger.warn("Login attempt unsuccessful: {} (error code {})", new Object[]{ErrorCode.getString(p_152897_1_), Integer.valueOf(p_152897_1_.getValue())});
            this.loggedIn = false;
        }
    }
    ...
    public void func_152891_a(BroadcastController.BroadcastState p_152891_1_) {
        Logger.debug("Broadcast state changed to {}", new Object[]{p_152891_1_});
    ...
    public void func_152894_a(StreamInfo p_152894_1_) {
        Logger.debug("Stream info updated; {} viewers on stream ID {}", new Object[]{Integer.valueOf(p_152894_1_.viewers), Long.valueOf(p_152894_1_.streamId)});
    }
    ...
    public void func_152893_b(ErrorCode p_152893_1_) {
        Logger.warn("Issue submitting frame: {} (Error code {})", new Object[]{ErrorCode.getString(p_152893_1_), Integer.valueOf(p_152893_1_.getValue())});
    ...
    public void func_152899_b() {
        this.updateStreamVolume();
        Logger.info("Broadcast to Twitch has started");
    }

    public void func_152901_c() {
        Logger.info("Broadcast to Twitch has stopped");
    }
    ...
    public void func_152907_a(IngestServerTester p_152907_1_, IngestServerTester.IngestTestState p_152907_2_) {
        Logger.debug("Ingest test state changed to {}", new Object[]{p_152907_2_});
    ...
    public void func_180607_b(String p_180607_1_) {
        Logger.debug("Chat disconnected");
